...
export const SCORE_CATEGORIES = [
  { name: "性格",         color: "#4298b4", params: ["主体性","外向性","協調性","曖昧耐性","競争心","ストレス耐性","好奇心","誠実性"] },
  { name: "能力",         color: "#33a474", params: ["論理思考","数学力","言語化能力","プレゼン力","英語力","IT理解","交渉力","リーダーシップ"] },
  { name: "モチベーション", color: "#f59e0b", params: ["成長","影響力","お金","安定","承認","権限","社会貢献","海外"] },
  { name: "働き方",       color: "#7c5e99", params: ["激務耐性","出張許容","チーム志向","海外志向"] },
] as const
